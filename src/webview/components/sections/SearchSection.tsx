...
const SearchSection: FC<SearchSectionProps> = ({ searchInputRef, globalSearchTerm, onSearchTermChange, onSearch, globalSearchLoading, globalSearchError, globalSearchResults, onOpenResult }) => (
	<div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px', height: '100%' }}>
		<div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
			...
			<input
				...
				onKeyDown={e => {
					if (e.key === 'Enter') onSearch(globalSearchTerm);
				}}
				style={{
					flex: 1,
					padding: '8px 12px',
			...
			<button
				type="button"
				onClick={() => onSearch(globalSearchTerm)}
